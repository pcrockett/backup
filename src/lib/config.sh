...
config:write_template_to() {
    # shellcheck disable=SC2154  # complaining about $version variable, defined by Bashly
    config:dump_stdin_to "${1}" <<EOF
# shellcheck shell=bash
#
# Initial config generated by backup v${version}
#
